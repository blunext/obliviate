...
var translationsSet = map[language.Tag][]translationPair{
	language.English: {
		...
		{"decryptNetworkError", "Error: Due to app update on 26.04 make sure that your sender used page that was open again after 26.04. Messages sent before 26.04 are lost. Sorry for inconvenience."},
		{"password", "Password"},
	...
	language.Polish: {
		...
		{"decryptNetworkError", "BŁĄD, WAŻNE: w związku z aktualizacją w dniu 26.04, upewnij się, że Twój nadawca wpisując wiadomosć użuwa nowo otwartej strony po 26.04. Wiadomości zaszyfrowane przez 27.04 zostaną utracone"},
		{"password", "Hasło"},
